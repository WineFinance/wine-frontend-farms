  ...
  return (
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          <Text fontSize="14px">{TranslateString(536, 'Total WINE Supply')}</Text>
        ...
        <Row>
          <Text fontSize="14px">{TranslateString(538, 'Total WINE Burned')}</Text>
          <CardValue fontSize="14px" value={getBalanceNumber(burnedBalance)} decimals={0} />
        </Row>
        <Row>
          <Text fontSize="14px">{TranslateString(540, 'New EGG/block')}</Text>
          <Text bold fontSize="14px">{winePerBlock}</Text>
        </Row>
      </CardBody>
    </StyledCakeStats>
  )
